...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  /// Navigate to the appropriate home screen based on user role and platform
  void _navigateToHome(AppUser? user) {
    if (user == null) return;

    // On web, always go to web admin dashboard (approval only)
    if (kIsWeb) {
      context.go(AppRoutes.webAdmin);
      return;
    }

    // On Android: Check if user is approved (admins are auto-approved)
