...
class EmergencyAlert {
  ...
  factory EmergencyAlert.fromMap(Map<dynamic, dynamic> map, {String? id}) {
    return EmergencyAlert(
      ...
      respondedAt: (map['respondedAt'] as num?)?.toInt(),
...
class EmergencyRepository {
  ...
  /// Stores in both main collection and active_emergencies atomically
  Future<String> createEmergency(EmergencyAlert emergency) async {
    final data = emergency.toMap();
    
    // Generate a key first, then write both paths atomically
    final emergencyId = _realtimeDb.generateKey(_emergenciesPath);
    ...
    updates['$_emergenciesPath/$emergencyId'] = payload;
    updates['$_activeEmergenciesPath/$emergencyId'] = payload;
